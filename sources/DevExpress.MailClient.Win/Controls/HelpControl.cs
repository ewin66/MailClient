...
namespace DevExpress.MailClient.Win.Controls {
    public partial class HelpControl : RibbonApplicationUserControl {
        ...
        void HelpControl_Load(object sender, EventArgs e) {
            aboutPanel = new AboutForm12(new DevExpress.Utils.About.ProductInfo(ProductKind.DXperienceWin, new ProductStringInfo("WinForms Controls", "Build Your Own Office")));
